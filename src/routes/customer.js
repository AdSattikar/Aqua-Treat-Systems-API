...
router.get('/customers/:firstname/:lastname', async (req, res) => {
...
router.put('/customers/:firstname/:lastname', async (req, res) => {
  const { firstname, lastname } = req.params;
...
router.delete('/customers/:firstname/:lastname', async (req, res) => {
  const { firstname, lastname } = req.params;
